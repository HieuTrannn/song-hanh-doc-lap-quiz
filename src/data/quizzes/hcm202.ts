...
export const hcm202Quiz: QuizSet = {
  ...
  title: "HCM202 — Tư tưởng Hồ Chí Minh về Độc lập Dân tộc",
  ...
  questions: [
    ...
    // ═══════════════════════════════════════
    {
      id: "btn-1",
      type: "buttons",
      prompt: "Vận dụng một cách sáng tạo lý luận cách mạng không ngừng của chủ nghĩa Mác - Lênin, trong Chánh cương vắn tắt của Đảng (năm 1930), Hồ Chí Minh đã khẳng định phương hướng chiến lược của cách mạng nước ta là gì?",
      durationSec: 20,
      maxScore: 1000,
      explanation: "Trang 114: \"...trong Chánh cương vắn tắt của Đảng (năm 1930), Hồ Chí Minh khẳng định phương hướng chiến lược của cách mạng nước ta là: 'làm tư sản dân quyền cách mạng và thổ địa cách mạng để đi tới xã hội cộng sản'\"",
      buttons: {
        options: [
    ...
    },
    {
      id: "btn-2",
      type: "buttons",
      prompt: "Theo tư tưởng Hồ Chí Minh, độc lập dân tộc bao gồm cả nội dung dân tộc và dân chủ; độc lập phải gắn liền với thống nhất, chủ quyền, toàn vẹn lãnh thổ và yếu tố cốt lõi nào sau đây?",
      imageUrl: "/images/vui-choi-cung-tre-em.jpg",
      durationSec: 20,
      maxScore: 1000,
      explanation: "Tài liệu ghi rõ: \"...hơn nữa độc lập dân tộc cũng phải gắn liền với tự do, cơm no, áo ấm, hạnh phúc cho nhân dân\". Các đáp án A, C, D là những cụm từ \"bẫy\" mang hơi hướng lý luận chính trị nhưng không nằm trong định nghĩa trực tiếp.",
      buttons: {
        options: [
    ...
    },
    {
      id: "btn-3",
      type: "buttons",
      prompt: "Tư tưởng của Hồ Chí Minh về việc \"độc lập dân tộc phải gắn liền với chủ nghĩa xã hội\" là đúng đắn và sáng tạo vì nó đáp ứng yêu cầu cụ thể của cách mạng Việt Nam và đồng thời phù hợp với điều gì?",
      imageUrl: "/images/toa-nha.jpg",
      durationSec: 20,
      maxScore: 1000,
      explanation: "Trang 115 khẳng định tư tưởng trên là đúng đắn và sáng tạo vì \"không chỉ đáp ứng được yêu cầu khách quan, cụ thể của cách mạng Việt Nam mà còn phù hợp với quy luật phát triển của thời đại\".",
      buttons: {
        options: [
    ...
    },
    {
      id: "btn-4",
      type: "buttons",
      prompt: "Năm 1960, Hồ Chí Minh đã khẳng định \"chỉ có chủ nghĩa xã hội, chủ nghĩa cộng sản mới giải phóng được các dân tộc bị áp bức và...\" đối tượng nào sau đây khỏi ách nô lệ?",
      imageUrl: "/images/dieu-hanh-hoi-xua.jpg",
      durationSec: 20,
      maxScore: 1000,
      explanation: "Theo đoạn trích năm 1960 của Hồ Chí Minh: \"chỉ có chủ nghĩa xã hội, chủ nghĩa cộng sản mới giải phóng được các dân tộc bị áp bức và những người lao động trên thế giới khỏi ách nô lệ\".",
      buttons: {
        options: [
    ...
    },
    {
      id: "btn-5",
      type: "buttons",
      prompt: "Hồ Chí Minh mô tả chủ nghĩa xã hội là một xã hội công bằng và hợp lý với nguyên tắc \"làm nhiều hưởng nhiều, làm ít hưởng ít, không làm không hưởng\". Đi kèm với nguyên tắc này, Nhà nước phải bảo đảm điều kiện gì?",
      imageUrl: "/images/bac-nam-tay-tre-em.jpg",
      durationSec: 20,
      maxScore: 1000,
      explanation: "Tài liệu nêu rõ nguyên tắc phân phối này đi liền với yêu cầu: \"bảo đảm phúc lợi xã hội cho người già, trẻ em và những người còn khó khăn trong cuộc sống\".",
      buttons: {
        options: [
    ...
    },
    {
      id: "btn-6",
      type: "buttons",
      prompt: "Đặc trưng về nền kinh tế của chủ nghĩa xã hội theo tư tưởng Hồ Chí Minh là một nền kinh tế phát triển cao, gắn liền với yếu tố nào để bảo đảm đời sống cho nhân dân?",
      imageUrl: "/images/ruong-lua.jpg",
      durationSec: 20,
      maxScore: 1000,
      explanation: "Chủ nghĩa xã hội ở Việt Nam \"là một xã hội có nền kinh tế phát triển cao, gắn liền với sự phát triển của khoa học kỹ thuật, bảo đảm đời sống vật chất và tinh thần cho nhân dân...\".",
      buttons: {
        options: [
    ...
    },
    {
      id: "btn-7",
      type: "buttons",
      prompt: "Hồ Chí Minh cảnh báo rằng, trong quá trình tiến hành cách mạng, nếu Đảng đánh mất vai trò lãnh đạo tuyệt đối thì hậu quả đối với chủ nghĩa xã hội sẽ là gì?",
      imageUrl: "/images/co-dang-tung-bay.jpg",
      durationSec: 20,
      maxScore: 1000,
      explanation: "Nằm ở Điều kiện thứ nhất để bảo đảm độc lập dân tộc gắn liền với CNXH: \"nếu không Đảng sẽ đánh mất vai trò lãnh đạo và chủ nghĩa xã hội sẽ sụp đổ, tan rã\".",
      buttons: {
        options: [
    ...
    },
    {
      ...
      durationSec: 20,
      maxScore: 1000,
      explanation: "Tài liệu khẳng định: \"Chủ nghĩa xã hội có khả năng làm cho đất nước phát triển mạnh mẽ, sẽ tạo nền tảng vững chắc để bảo vệ nền độc lập dân tộc...\"",
      buttons: {
        options: [
    ...
    // ═══════════════════════════════════════
    {
      id: "chk-1",
      type: "checkboxes",
      prompt: "Những khẳng định nào sau đây là ĐÚNG khi nói về vị trí và vai trò của độc lập dân tộc theo tư tưởng Hồ Chí Minh?",
      imageUrl: "/images/lang-bac.jpg",
      durationSec: 25,
      maxScore: 1000,
      explanation: "Đáp án A, C, D đều đúng. B sai vì tài liệu ghi rõ: 'Khi đề cao mục tiêu độc lập dân tộc, Hồ Chí Minh không coi đó là mục tiêu cuối cùng của cách mạng, mà là tiền đề cho một cuộc cách mạng tiếp theo'.",
      checkboxes: {
        options: [
    ...
    },
    {
      id: "chk-3",
      type: "checkboxes",
      prompt: "Hồ Chí Minh đã nhận định thế nào về \"chủ nghĩa xã hội ở Việt Nam\" trong việc thiết lập một chế độ chính trị và pháp luật?",
      imageUrl: "/images/dieu-hanh.jpg",
      durationSec: 25,
      maxScore: 1000,
      explanation: "\"Theo Hồ Chí Minh, chủ nghĩa xã hội ở Việt Nam trước hết là một chế độ dân chủ, do nhân dân làm chủ, dưới sự lãnh đạo của Đảng Cộng sản. Chế độ dân chủ thể hiện trong tất cả mọi mặt của đời sống xã hội và được thể chế hóa bằng pháp luật\". Đáp án D sai.",
      checkboxes: {
        options: [
    ...
    },
    {
      id: "chk-4",
      type: "checkboxes",
      prompt: "Những đặc trưng nào sau đây của chủ nghĩa xã hội (theo tư tưởng Hồ Chí Minh) giúp tạo nên nền tảng vững chắc cho đất nước?",
      imageUrl: "/images/bat-tay.jpg",
      durationSec: 25,
      maxScore: 1000,
      explanation: "Đoạn văn miêu tả CNXH: \"...phát triển của khoa học kỹ thuật, bảo đảm đời sống vật chất và tinh thần cho nhân dân, là một xã hội có sự phát triển cao về đạo đức và văn hóa\". Đáp án B sai vì văn bản ghi là \"hòa bình hữu nghị, làm bạn với tất cả các nước dân chủ trên thế giới\".",
      checkboxes: {
        options: [
    ...
    },
    {
      id: "chk-5",
      type: "checkboxes",
      prompt: "Trong tiểu mục \"Điều kiện để bảo đảm độc lập dân tộc gắn liền với chủ nghĩa xã hội\", ba điều kiện mang tính nguyên tắc được Hồ Chí Minh đưa ra là gì?",
      imageUrl: "/images/thuyet-trinh.jpg",
      durationSec: 25,
      maxScore: 1000,
      explanation: "Theo giáo trình, 3 điều kiện được đánh số rõ ràng là: \"Một là, phải bảo đảm vai trò lãnh đạo tuyệt đối của Đảng...\", \"Hai là, phải củng cố và tăng cường khối đại đoàn kết dân tộc...\", và \"Ba là, phải đoàn kết, gắn bó chặt chẽ với cách mạng thế giới\". Đáp án B hoàn toàn bịa đặt.",
      checkboxes: {
        options: [
    ...
    },
    {
      id: "chk-6",
      type: "checkboxes",
      prompt: "Về khối đại đoàn kết toàn dân tộc (điều kiện thứ hai để bảo vệ độc lập và CNXH), Hồ Chí Minh đã có những quan điểm nào?",
      durationSec: 25,
      maxScore: 1000,
      explanation: "Tài liệu trích xuất chính xác: \"...nền tảng là khối liên minh công - nông, vì theo Người, đại đoàn kết dân tộc là vấn đề có ý nghĩa chiến lược, quyết định sự thành công của cách mạng\". Đáp án B sai vì đại đoàn kết có ý nghĩa chiến lược, không phải sách lược tạm thời.",
      checkboxes: {
        options: [
    ...
    },
    {
      id: "chk-7",
      type: "checkboxes",
      prompt: "Việc thực hiện \"đoàn kết quốc tế\" (điều kiện thứ ba) theo Hồ Chí Minh hướng tới những mục đích to lớn nào?",
      imageUrl: "/images/chim-bay-tu-do.jpg",
      durationSec: 25,
      maxScore: 1000,
      explanation: "\"Đoàn kết quốc tế, theo Hồ Chí Minh, là để tạo ra một sức mạnh to lớn cho cách mạng và cũng để góp phần chung cho nền hòa bình, độc lập, dân chủ và chủ nghĩa xã hội trên thế giới\". Đáp án D sai hoàn toàn với tinh thần độc lập tự chủ của Hồ Chí Minh.",
      checkboxes: {
        options: [
